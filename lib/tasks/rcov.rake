  ...
  namespace 'rcov' do
    ...
    namespace 'unit' do
      Rcov::RcovTask.new do |t|
        ...
        t.verbose = true
        t.rcov_opts = ['-x', '^config/boot,^/Library,^lib/ext/net_http_post,^lib/authenticate', '--rails',
                       # '--sort', 'name',
                       '--sort', 'coverage',
                       #'--only-uncovered',
    ...
    if File.exist?(rspec_base)
      ...
      Spec::Rake::SpecTask.new(:spec) do |t|
        ...
        t.rcov = true
        t.rcov_opts = ['--exclude', 'spec,^/Library,^lib/ext/net_http_post,^lib/authenticate', '--rails',
                       '--sort', 'coverage',
                       '--aggregate', 'coverage.data']
      end
    end
